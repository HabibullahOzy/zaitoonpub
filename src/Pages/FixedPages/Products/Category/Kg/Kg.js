...
const Kg = () => {
    ...
    const { data: nursproduct = [], refetch } = useQuery({
        ...
        queryFn: async () => {
            const res = await fetch(`${process.env.REACT_APP_backendurl}/categoryproducts/KG`);
    ...
    return (
        <div>
            <h1 className='font-semibold text-2xl'>KG</h1>
            <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5 w-10/12 py-6 mx-auto' style={{ color: "black" }}>
                ...
                {nursproduct?.map((product, i) => {
                    ...
                    return (
                        ...
                        //         <p className='text-center'>{product.namebn}</p>
                        ...
                        //                 </>
                        //             ) : (
                        //                 <p className='font-semibold text-green-600'>{product.productPrice} ৳</p>
                        //             )}
                        //         </div>
                        //     </div>
                        // </div>
